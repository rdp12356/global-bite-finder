  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          >
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">Taste the World</span>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-gray-400">
                ...
                <span className="text-sm">123 Food Street, Culinary City, CC 12345</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
              ...
              <div className="flex items-center space-x-3 text-gray-400">
                ...
                <span className="text-sm">hello@tastetheworld.com</span>
              </div>
            </div>
          </motion.div>
        ...
        >
          <p>&copy; {currentYear} Taste the World. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  )
